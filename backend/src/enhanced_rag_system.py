...
from .smart_code_analyzer import SmartCodeAnalyzer, FileAnalysis, ArchitectureAnalysis

logger = logging.getLogger(__name__)

@dataclass 
class EnhancedQueryResult:
    """Enhanced query result with deep code insights"""
    query: str
    response: str
    confidence: float
...
class EnhancedRAGSystem:
    """Enhanced RAG with deep code understanding and intelligent context gathering"""
    ...
    def enhanced_query(self, repo_id: str, query: str, max_results: int = 10) -> EnhancedQueryResult:
        ...
        # Step 7: Generate response with Claude if available
        if self.claude_analyzer and self.claude_analyzer.available:
            claude_response = self._enhanced_claude_analysis(
                query, query_intent, smart_context, specialized_analysis, file_analyses
            )
    ...
    def _enhanced_claude_analysis(self, query: str, intent: Dict[str, Any], smart_context: Dict[str, Any], 
                                 specialized_analysis: Dict[str, Any], file_analyses: List[FileAnalysis]) -> Dict[str, Any]:
        ...
        enhanced_prompt = prompt_creator(query, intent, smart_context, specialized_analysis, file_analyses)
    ...
    def _create_security_expert_prompt(self, query: str, intent: Dict[str, Any], smart_context: Dict[str, Any], 
                                     specialized_analysis: Dict[str, Any], file_analyses: List[FileAnalysis]) -> str:
...
"""
    ...
    def _create_fallback_response(self, query: str, smart_context: Dict[str, Any], specialized_analysis: Dict[str, Any]) -> EnhancedQueryResult:
